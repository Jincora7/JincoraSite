        ...
        <main>
            <div className="wrap">
                <div ref={addToContentRefs} className="content content--sticky content--grid bg-1" >
                    ...
                    <img className="content__img" src="src\assets\stickyImg\1st.png" alt="The Algorithm" />
                </div>
                <div ref={addToContentRefs} className="content content--sticky content--img-left  content--grid bg-2">
                    ...
                    <img className="content__img " src="src\assets\stickyImg\2nd.png" alt="The Dogma" />
                </div>
                <div ref={addToContentRefs} className="content content--sticky content--grid bg-3">
                    ...
                    <img className="content__img  content__img3" src="src\assets\stickyImg\3rd.png" alt="The Architects" />
                </div>
                <div ref={addToContentRefs} className="content content--sticky content--img-left content--grid bg-4">
                    ...
                    <img className="content__img content__img4" src="src\assets\stickyImg\4th.png" alt="The Wasteland" />
                </div>
                <div ref={addToContentRefs} className="content content--sticky content--grid bg-5">
                    ...
                    <img className="content__img  content__img--right" src="src\assets\stickyImg\5th.png" alt="The Narrative" />
                </div>
