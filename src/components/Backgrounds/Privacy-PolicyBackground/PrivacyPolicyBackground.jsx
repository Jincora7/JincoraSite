import "./PrivacyPolicyBackground.css"

import React from 'react'

function PrivacyPolicyBackground() {
  return (
    <div className="policy-page-background-wrapper">
      <div className="policy-ellipse-1"></div>
      <div className="policy-ellipse-2"></div>
...
export default PrivacyPolicyBackground